#!/usr/bin/env python3
"""
Recuperation des codes promo Petit Bateau depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/petit-bateau.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/petit-bateau.fr"
STORE_NAME = "Petit Bateau"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Petit Bateau depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-petit-bateau)"
    }
    try:
